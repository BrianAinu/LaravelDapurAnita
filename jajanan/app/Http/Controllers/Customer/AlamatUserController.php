...
class AlamatUserController extends Controller
{
    ...
    public function storeApi(Request $request)
    {
        ...
        return response()->json(['message' => 'Alamat disimpan', 'data' => $alamat]);
    }

    // PUT /api/alamatUpdateApi/{id}
    public function updateApi(Request $request, $id)
    {
        ...
        return response()->json(['message' => 'Alamat diperbarui', 'data' => $alamat]);
    }

    // DELETE /api/alamatDeleteApi/{id}
